...
opt = optim.Adam(model.parameters(),lr = 0.0001,betas=(0.9, 0.999),eps=1e-09,weight_decay=0,amsgrad=False)   #指定一个优化器来跑当前的模型
...
# 原0.00001
# opt = optim.Adam(model.parameters(),lr = 0.0001,betas=(0.9, 0.999),eps=1e-09,weight_decay=0,amsgrad=False)
...
def test():
    ...
    print("\nTest set: Average loss: {:.4f}, Accuracy: {}/{}({:.3f}%\n".format(ss.item(),correct,test_dataset.__len__(),
